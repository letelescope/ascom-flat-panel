...
//
// ASCOM CoverCalibrator driver for LeTelescopeFF-FP-001
//
...
namespace ASCOM.LeTelescopeFF-FP-001.CoverCalibrator
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.LeTelescopeFF-FP-001.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.LeTelescopeFF-FP-001.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _LeTelescopeFF-FP-001 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
[Guid("4dcd9013-fbe0-4ea0-9e8f-fadfec16a29d")]
[ProgId("ASCOM.LeTelescopeFF-FP-001.CoverCalibrator")]
[ServedClassName("ASCOM CoverCalibrator Driver for LeTelescopeFF-FP-001")] // Driver description that appears in the Chooser, customise as required
...
public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV1, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LeTelescopeFF-FP-001"/> class. Must be public to successfully register for COM.
    /// </summary>
    public CoverCalibrator()
    {
        try
        {
            ...
            tl = new TraceLogger("", "LeTelescopeFF-FP-001.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
            SetTraceState();
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.LeTelescopeFF-FP-001.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
