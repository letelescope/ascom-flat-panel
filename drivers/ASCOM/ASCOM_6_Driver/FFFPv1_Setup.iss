...
;
[Setup]
AppID={{2517e80f-5a61-4789-9d92-36111e4ff086}
AppName=ASCOM FFFPv1 CoverCalibrator Driver
AppVerName=ASCOM FFFPv1 CoverCalibrator Driver 1.0.0.beta
...
[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\FFFPv1"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: ".\bin\Release\ASCOM.LeTelescopeFFFPV1.exe"; DestDir: "{app}"
...
Filename: "{app}\ASCOM.LeTelescopeFFFPV1.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.LeTelescopeFFFPV1.exe"; Parameters: "/unregister"
